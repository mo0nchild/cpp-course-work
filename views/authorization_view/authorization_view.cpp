...
void AuthorizationView::InitializeComponent(void)
{
    ...
    this->page1_label_easter_egg = (gcnew System::Windows::Forms::Label());
    this->page1_button_show = (gcnew System::Windows::Forms::Button());
    ...
    this->page2_button_show = (gcnew System::Windows::Forms::Button());
    ...
    this->page_list->Size = System::Drawing::Size(452, 400);
    ...
    this->page_authorization->Controls->Add(this->page1_label_easter_egg);
    this->page_authorization->Controls->Add(this->page1_button_show);
    ...
    this->page_authorization->Size = System::Drawing::Size(444, 367);
    this->page_authorization->TabIndex = 0;
    this->page_authorization->Text = L"Авторизация";
    // 
    // page1_label_easter_egg
    // 
    this->page1_label_easter_egg->AutoSize = true;
    this->page1_label_easter_egg->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 8));
    this->page1_label_easter_egg->Location = System::Drawing::Point(8, 349);
    this->page1_label_easter_egg->Name = L"page1_label_easter_egg";
    this->page1_label_easter_egg->Size = System::Drawing::Size(144, 13);
    this->page1_label_easter_egg->TabIndex = 23;
    this->page1_label_easter_egg->Text = L"Сеть сервисов \"387 - PVO\"";
    // 
    // page1_button_show
    // 
    this->page1_button_show->BackColor = System::Drawing::Color::Transparent;
    this->page1_button_show->FlatStyle = System::Windows::Forms::FlatStyle::Popup;
    this->page1_button_show->Location = System::Drawing::Point(353, 221);
    this->page1_button_show->Name = L"page1_button_show";
    this->page1_button_show->Size = System::Drawing::Size(29, 26);
    this->page1_button_show->TabIndex = 22;
    this->page1_button_show->UseVisualStyleBackColor = false;
    this->page1_button_show->Click += gcnew System::EventHandler(this, &AuthorizationView::page1_button_show_Click);
    // 
    ...
    this->page1_textbox_password->Size = System::Drawing::Size(287, 26);
    ...
    this->page_registration->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(127)),
        static_cast<System::Int32>(static_cast<System::Byte>(112)), static_cast<System::Int32>(static_cast<System::Byte>(216)));
    this->page_registration->Controls->Add(this->page2_button_show);
    ...
    this->page_registration->Size = System::Drawing::Size(444, 367);
    this->page_registration->TabIndex = 1;
    this->page_registration->Text = L"Регистрация";
    // 
    // page2_button_show
    // 
    this->page2_button_show->BackColor = System::Drawing::Color::Transparent;
    this->page2_button_show->FlatStyle = System::Windows::Forms::FlatStyle::Popup;
    this->page2_button_show->Location = System::Drawing::Point(382, 26);
    this->page2_button_show->Name = L"page2_button_show";
    this->page2_button_show->Size = System::Drawing::Size(29, 26);
    this->page2_button_show->TabIndex = 24;
    this->page2_button_show->UseVisualStyleBackColor = false;
    this->page2_button_show->Click += gcnew System::EventHandler(this, &AuthorizationView::page2_button_show_Click);
    // 
    ...
    this->page2_textbox_password->Size = System::Drawing::Size(132, 26);
    ...
    this->ClientSize = System::Drawing::Size(452, 400);
    this->Controls->Add(this->page_list);
    this->MaximizeBox = false;
    this->MaximumSize = System::Drawing::Size(468, 439);
    this->MinimizeBox = false;
    this->MinimumSize = System::Drawing::Size(468, 439);
