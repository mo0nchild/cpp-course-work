...
namespace Services 
{
	...
	public: [Services::SqlDatabaseFieldAttribute("driver_status")]	property System::String^ driver_state;
	...
	public: [Services::SqlDatabaseFieldAttribute("car_count")]		property System::String^ car_count; 
