...
namespace Services
{
	...
	public: [Services::SqlDatabaseFieldAttribute("account_money")] property System::String^ account_money;
		...
		BankAccountDbScheme(System::String^ p1, System::String^ p2) { this->account_guid = p1; this->account_money = p2; }
		BankAccountDbScheme(System::Void) { this->account_guid = ""; this->account_money = ""; }
		virtual ~BankAccountDbScheme(System::Void) { delete account_guid, account_money; }
	};
}